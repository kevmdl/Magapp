...
ALTER TABLE mensagens MODIFY COLUMN is_read BOOLEAN DEFAULT FALSE;

-- Índices para melhor performance
CREATE INDEX idx_chat_messages ON mensagens (id, created_at);
CREATE INDEX idx_user_messages ON mensagens (sender_id, receiver_id);